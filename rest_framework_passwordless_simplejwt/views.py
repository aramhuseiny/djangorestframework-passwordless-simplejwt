...
class TokenBlacklistView(TokenViewBase):
    ...
    `rest_framework_passwordless_simplejwt.token_blacklist` app installed.
    """
...
class SendCodeView(TokenViewBase):
    """
    Call API to send OneTimePassword  code
    """

    _serializer_class = api_settings.SEND_CODE_SERIALIZER

send_code = SendCodeView.as_view()