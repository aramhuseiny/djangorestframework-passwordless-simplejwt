...
from rest_framework_passwordless_simplejwt.exceptions import TokenError
from rest_framework_passwordless_simplejwt.serializers import (
...
from rest_framework_passwordless_simplejwt.settings import api_settings
from rest_framework_passwordless_simplejwt.token_blacklist.models import (
    BlacklistedToken,
    OutstandingToken,
)
from rest_framework_passwordless_simplejwt.tokens import AccessToken, RefreshToken, SlidingToken
from rest_framework_passwordless_simplejwt.utils import (
    aware_utcnow,
    datetime_from_epoch,
    datetime_to_epoch,
)
...
class TestTokenRefreshSerializer(TestCase):
    ...
    def test_it_should_return_access_token_if_everything_ok(self):
        ...
        with patch("rest_framework_passwordless_simplejwt.tokens.aware_utcnow") as fake_aware_utcnow:
    ...
    def test_it_should_return_refresh_token_if_tokens_should_be_rotated(self):
        ...
        with override_api_settings(
            ...
            with patch(
                "rest_framework_passwordless_simplejwt.tokens.aware_utcnow"
