...
from rest_framework_passwordless_simplejwt.backends import JWK_CLIENT_AVAILABLE, TokenBackend
from rest_framework_passwordless_simplejwt.exceptions import TokenBackendError
...
class TestTokenBackend(TestCase):
    ...
    def test_decode_rsa_aud_iss_jwk_success(self):
        ...
        with patch("rest_framework_passwordless_simplejwt.backends.PyJWKClient") as mock_jwk_module:
