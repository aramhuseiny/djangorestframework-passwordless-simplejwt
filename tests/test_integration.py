...
from rest_framework_passwordless_simplejwt.compat import reverse
from rest_framework_passwordless_simplejwt.settings import api_settings
from rest_framework_passwordless_simplejwt.tokens import AccessToken
...
class TestTestView(APIViewTestCase):
    ...
    def test_user_can_get_sliding_token_and_use_it(self):
        ...
        with override_api_settings(
            AUTH_TOKEN_CLASSES=("rest_framework_passwordless_simplejwt.tokens.SlidingToken",)
        ):
            res = self.view_get()
