...
from rest_framework_passwordless_simplejwt import authentication
from rest_framework_passwordless_simplejwt.exceptions import AuthenticationFailed, InvalidToken
from rest_framework_passwordless_simplejwt.models import TokenUser
from rest_framework_passwordless_simplejwt.settings import api_settings
from rest_framework_passwordless_simplejwt.tokens import AccessToken, SlidingToken
...
class TestJWTAuthentication(TestCase):
    ...
    def test_get_validated_token(self):
        ...
        with override_api_settings(
            AUTH_TOKEN_CLASSES=(
                "rest_framework_passwordless_simplejwt.tokens.AccessToken",
                "rest_framework_passwordless_simplejwt.tokens.SlidingToken",
            )
        ):
