...
``settings.py``, add
``rest_framework_passwordless_simplejwt.authentication.JWTAuthentication`` to the list of
...
.. code-block:: python
  ...
  REST_FRAMEWORK = {
      ...
      'DEFAULT_AUTHENTICATION_CLASSES': (
          ...
          'rest_framework_passwordless_simplejwt.authentication.JWTAuthentication',
      )
      ...
  }
...
.. code-block:: python
  ...
  from rest_framework_passwordless_simplejwt.views import TokenVerifyView
...
``rest_framework_passwordless_simplejwt`` to ``INSTALLED_APPS``.

.. code-block:: python

  INSTALLED_APPS = [
      ...
      'rest_framework_passwordless_simplejwt',
      ...
  ]
