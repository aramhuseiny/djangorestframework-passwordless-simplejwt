...
``rest_framework_passwordless_simplejwt.models.TokenUser`` instance which acts as a
...
``rest_framework_passwordless_simplejwt.authentication.JWTStatelessUserAuthentication`` backend
...
.. code-block:: python
  ...
  REST_FRAMEWORK = {
      ...
      'DEFAULT_AUTHENTICATION_CLASSES': (
          ...
          'rest_framework_passwordless_simplejwt.authentication.JWTStatelessUserAuthentication',
      )
      ...
  }
