...
.. code-block:: python
  ...
  from rest_framework_passwordless_simplejwt.serializers import TokenObtainPairSerializer
  from rest_framework_passwordless_simplejwt.views import TokenObtainPairView
