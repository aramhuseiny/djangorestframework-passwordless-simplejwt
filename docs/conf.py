...
release = get_distribution("djangorestframework_passwordless_simplejwt").version
...
htmlhelp_basename = "rest_framework_passwordless_simplejwtdoc"
...
latex_documents = [
    (
        "index",
        "rest_framework_passwordless_simplejwt.tex",
